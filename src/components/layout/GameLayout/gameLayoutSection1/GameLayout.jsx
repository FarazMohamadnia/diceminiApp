        ...
        <div>
            ...
            <div className='GameLayout1-section2-bodyStyle'>
                ...
                <div className='w-1/2 text-center mt-1'>
                    ...
                    <Link to={'/dice-detail'}>
                        <button className='GameLayout1-section2-BTN'><span className='w-[25%]'><BuyCrypto/></span><span
                            className='w-[75%]'>BUY DTS</span></button>
                    </Link>
                    <Link>
                        <button className='GameLayout1-section2-BTN'><span className='w-[25%]'><AddIcon/></span><span
                            className='w-[75%]'>EARN DTS</span></button>
                    </Link>
                </div>
            </div>
            <div className='GameLayout1-section2-bodyStyle'>
                ...
                <div className='w-1/2 text-center mt-1'>
                    <div>
                        <button onClick={() => setIsModalOpen2(true)} className='GameLayout1-section2-BTN'><span
                            className='w-[25%]'><InfoIcon/></span><span className='w-[75%]'>WHAT IS DICE ?</span>
                        </button>
                        <ModalExample data={modalfakedata[1]} isOpen={IsModalOpen2}
                                      onClose={() => setIsModalOpen2(false)}/>
                    </div>
                    <Link to={'/dice-detail'}>
                        <button className='GameLayout1-section2-BTN'><span className='w-[25%]'><SellIcon/></span><span
                            className='w-[75%]'>SELL YOUR DICE</span></button>
                    </Link>
                    <Link>
