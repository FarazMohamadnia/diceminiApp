        ...
        <div className=" min-h-[100vh] w-full flex justify-center items-center">
            <div className="dicegame2-container relative">
                ...
                <div className="flex justify-between items-center px-6 absolute bottom-0 w-full">
                        ...
                        <button className="flex justify-center items-center relative">
                            ...
                            <svg width="17" height="8" viewBox="0 0 17 8" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.850098" y="0.950012" width="15.3" height="6.375" rx="3.1875"
                                          fill="white"/>
                                </svg>
                            </span>
                        </button>
                    ...
                    <div>
                        <p className="text-white text-[20px] font-bold">2.00 <span className="text-[#ffcf60]">DTS</span>
                        </p>
                    </div>
                    <div className="flex">
                        <button className="flex justify-center items-center relative">
                            ...
                            <span className="absolute">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                  ...
                                  <rect x="10.1499" width="15.3" height="5" rx="2.5" transform="rotate(90 10.1499 0)"
                                        fill="white"/>
                                </svg>
                            </span>
