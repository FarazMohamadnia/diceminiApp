  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-xs">
        ...
        >
          <g id="vuesax/bold/arrow-down">
            <g id="arrow-down">
              <path
                id="Vector"
                d="M8.21334 3.74915H5.35792H2.78667C2.34667 3.74915 2.12667 4.28081 2.43834 4.59248L4.81251 6.96665C5.19292 7.34706 5.81167 7.34706 6.19209 6.96665L7.09501 6.06373L8.56626 4.59248C8.87334 4.28081 8.65334 3.74915 8.21334 3.74915Z"
                fill="white"
              />
            </g>
          </g>
      ...
      {isOpen && (
        <ul
          className="
            absolute z-20 mt-2 w-full rounded-md bg-[#0F2B3E]
        ...
        >
          {options.map((option) => {
            const isDisabled = !!disableList.find((item) => item === option);

            return (
              <li key={option}>
                <button
                  className={`block w-full text-left px-4 py-2 hover:bg-[#1F4E63] transition-colors duration-150 ${
