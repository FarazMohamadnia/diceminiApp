...
const ConnectWalletButton =() => {
  ...
  return (
    ...
    {!wallet?.account.address ?
      <button
        className="w-full flex justify-center items-center space-x-2 border border-[#00F0FF] rounded-xl px-6 py-[14px] text-[#00F0FF]"
        style={{
          background:
      ...
      :
        <AddressDisplay address={user?.address} disconnectWallet={disconnectWallet}/>
    }
