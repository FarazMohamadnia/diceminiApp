        ...
        <div>
            ...
            <div>
                <div className="flex justify-center items-center w-3/5 h-[150px] mt-7 mx-auto mb-3">
                    <div className="w-1/2"><DiceGroup /></div>
                    <div className="w-1/2 text-center">
                        <p className="text-[#F42500] text-[10px]">Available Dice for sell:</p>
                        <p className="mt-3"><span className="text-white mr-2">4</span><span className="text-[#1ae5a1]">DICES</span></p>
                ...
                <div>
                    <div className="flex text-white justify-center items-center text-[12px]">
                        ...
                        <p className="">0.6 <span className="text-[#1AE5A1] text-[13px]">USD</span></p>
                    </div>
                </div>
